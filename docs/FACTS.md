...
- ✅ CURRENT stack (Ethereum Sepolia, chainId 11155111) — Phase 3, 2026-06-08, both VERIFIED on Etherscan:
  - **MockUSDC** `0x4C4D1223BcC47E380CF4C37652EaDFe10A9Fd910` (our 6-decimal USDC, mintable; chosen for deterministic demo — CAW can't dispense USDC). `Pass - Verified`.
  - **Escrow** `0xe8eB3a0233D8E227636f91f45Cd17583Be6A1008`, bound to MockUSDC (`escrow.token()` confirmed). `Pass - Verified`.
    Explorer: https://sepolia.etherscan.io/address/0xe8eb3a0233d8e227636f91f45cd17583be6a1008
  - Client minted 1000 USDC (balanceOf = 1e9 raw). Deploy script: `contracts/script/DeployPhase3.s.sol`.
